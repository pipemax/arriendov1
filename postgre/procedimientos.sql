...
CREATE OR REPLACE FUNCTION INSERTAR_ADMINISTRADOR(
    RUT_U IN ADMINISTRADOR.RUT%TYPE,
    NOMBRES_U IN ADMINISTRADOR.NOMBRES%TYPE,  
    APELLIDOS_U IN ADMINISTRADOR.APELLIDOS%TYPE,
    CORREO_U IN ADMINISTRADOR.CORREO%TYPE,
    PASS_U IN ADMINISTRADOR.PASS%TYPE,
    CELULAR_U IN ADMINISTRADOR.CELULAR%TYPE,
    EMPRESA_U IN ADMINISTRADOR.EMPRESA%TYPE,
    COMUNA_U IN ADMINISTRADOR.COMUNA%TYPE,
    RUT_A IN ADMINISTRADOR.RUT_A%TYPE,
    BOOL OUT VARCHAR,
    MESSAGE OUT VARCHAR)
RETURNS RECORD AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION ACTUALIZAR_ADMINISTRADOR(
    RUT_AD IN ADMINISTRADOR.RUT%TYPE,
    NOMBRES_A IN ADMINISTRADOR.NOMBRES%TYPE,
    APELLIDOS_A IN ADMINISTRADOR.APELLIDOS%TYPE,
    COMUNA_A IN ADMINISTRADOR.COMUNA%TYPE,
    CORREO_A IN ADMINISTRADOR.CORREO%TYPE,
    CELULAR_U IN ADMINISTRADOR.CELULAR%TYPE,
    BOOL OUT VARCHAR,
    MESSAGE OUT VARCHAR)
RETURNS RECORD AS $$
...
CREATE OR REPLACE FUNCTION ACTUALIZAR_PASSWORD_USER_VERIFICAR(
    RUT_U IN USUARIO.RUT%TYPE,
    PASS_U IN USUARIO.PASS%TYPE,
    NEW_PASS IN USUARIO.PASS%TYPE,
    BOOL OUT VARCHAR,
    MESSAGE OUT VARCHAR)
RETURNS RECORD AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION ACTUALIZAR_PASSWORD_ADMINISTRADOR(
    RUT_U IN USUARIO.RUT%TYPE,
    PASS_U IN USUARIO.PASS%TYPE,
    BOOL OUT VARCHAR,
    MESSAGE OUT VARCHAR)
...
CREATE OR REPLACE FUNCTION NUEVA_HERRAMIENTA(
    ...
    EMPRESA_H IN HERRAMIENTA.EMPRESA%TYPE,
    BOOL OUT VARCHAR,
    MESSAGE OUT VARCHAR
)
RETURNS RECORD AS $$
...
CREATE OR REPLACE FUNCTION VINCULAR_HERRAMIENTA_SUCURSAL(
    ...
    EMPRESA_H IN SUCURSAL_HERRAMIENTA.EMPRESA%TYPE,
    DESCUENTO_H IN SUCURSAL_HERRAMIENTA.DESCUENTO%TYPE,
    INICIO_H IN VARCHAR,
    FIN_H IN VARCHAR,
    BOOL OUT VARCHAR,
    MESSAGE OUT VARCHAR)
...
drop function actualizar_h_sucursal(int,int,int,int,int);
CREATE OR REPLACE FUNCTION ACTUALIZAR_H_SUCURSAL(
    ...
    EMPRESA_H IN SUCURSAL_HERRAMIENTA.EMPRESA%TYPE,
    DESCUENTO_H IN SUCURSAL_HERRAMIENTA.DESCUENTO%TYPE,
    INICIO_H IN SUCURSAL_HERRAMIENTA.F_INICIO_D%TYPE,
    FIN_H IN SUCURSAL_HERRAMIENTA.F_FINAL_D%TYPE,
    BOOL OUT VARCHAR,
    MESSAGE OUT VARCHAR)
RETURNS RECORD AS $$ 
DECLARE
...
drop function aumentar_stock(int,int,int);
...
drop function quitar_stock(int,int,int,varchar,varchar);
...
CREATE OR REPLACE FUNCTION NUEVA_SUCURSAL(
    ...
    COMUNA_S IN SUCURSAL.COMUNA%TYPE,
    BOOL OUT VARCHAR,
    MESSAGE OUT VARCHAR)
RETURNS RECORD AS $$ 
DECLARE 
...
CREATE OR REPLACE FUNCTION ELIMINAR_SUCURSAL(
    ...
    EMPRESA_S IN SUCURSAL.COD_EMPRESA%TYPE,
    BOOL OUT VARCHAR,
    MESSAGE OUT VARCHAR)
RETURNS RECORD AS $$ 
DECLARE
...
CREATE OR REPLACE FUNCTION OBTENERPASSADMIN(
    RUT_U IN USUARIO.RUT%TYPE,
    BOOL OUT VARCHAR,
    MESSAGE OUT VARCHAR)
RETURNS RECORD AS $$ 
...
CREATE OR REPLACE FUNCTION AGREGA_CARRITO(
    ...
    CODIGO IN CARRITO.COD_HERRAMIENTA%TYPE,
    CODIGO_S IN CARRITO.COD_SUCURSAL%TYPE,
    EMPRESA_H IN CARRITO.EMPRESA%TYPE,
    COMUNA_H IN COMUNA.COMUNA_ID%TYPE,
    FECHA_I IN VARCHAR,
    FECHA_F IN VARCHAR,
    CANTIDAD_C IN CARRITO.CANTIDAD%TYPE,    
    BOOL OUT VARCHAR,
    MESSAGE OUT VARCHAR)
RETURNS RECORD AS $$ 
DECLARE
...
select bool,message from inicio_sesion_admin(123123123,'123123');
CREATE OR REPLACE FUNCTION INICIO_SESION_ADMIN(
    RUT_U IN USUARIO.RUT%TYPE,
    PASS_U IN USUARIO.PASS%TYPE,
    BOOL OUT VARCHAR,
    MESSAGE OUT VARCHAR)
...
CREATE OR REPLACE FUNCTION MODIFICAR_DETALLE(
    HERRAMIENTA_D IN DETALLE.COD_H%TYPE,
    SUCURSAL_D IN DETALLE.COD_SUCURSAL%TYPE,
    EMPRESA_D IN DETALLE.EMPRESA%TYPE,
    ARRIENDO_D IN DETALLE.ID_A%TYPE,
    ESTADO_D IN DETALLE.ESTADO%TYPE,
    BOOL OUT VARCHAR,
    MESSAGE OUT VARCHAR)
RETURNS RECORD AS $$ 
DECLARE
...
select verificar_descuentos();
CREATE OR REPLACE FUNCTION VERIFICAR_DESCUENTOS()
RETURNS VOID AS $$
DECLARE
