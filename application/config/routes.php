...
$route['detalle/(:num)/(:num)/(:num)'] = 'Inicio/detalle/$1/$2/$3';
$route['detalle/(:num)/(:num)'] = 'Inicio/productos/';
$route['detalle/(:num)'] = 'Inicio/productos/';
...
$route['actualizar-contrasena'] = 'Inicio/actualizar_contrasena';
$route['actualizar-datos'] = 'Inicio/actualizar_datos';