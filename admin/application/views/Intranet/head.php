                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li>
                                <a href="<?php echo base_url();?>administradores/" aria-expanded="true"><i class="ti-dashboard"></i><span>Administradores</span></a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>sucursales/" aria-expanded="true"><i class="fa fa-home"></i><span>Sucursales</span></a>
                            </li>
                            ...
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-align-left"></i> <span>SIN USO</span></a>
                                <ul class="collapse">
